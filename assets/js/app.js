...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(fn);

function fn() {
  var activeSlideIndex = 0,
      nextSlideIndex,
      previousSlideIndex;
  var $nextButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#next-button'),
      $previousButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#previous-button');
  showSlide(activeSlideIndex);

  function showSlide(n) {
    var i,
        $slides = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slide'),
        m = $slides.length - 1;
    ...
    var previousSlide = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + 'slide-' + previousSlideIndex).detach();
    var activeSlide = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + 'slide-' + activeSlideIndex).detach();
    var nextSlide = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#' + 'slide-' + nextSlideIndex).detach();
    previousSlide.appendTo('#slideshow-2');
    activeSlide.appendTo('#slideshow-1');
    nextSlide.prependTo('#slideshow-2');
    var $slide1 = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#slideshow-1 .slide')[0],
        $slide2 = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#slideshow-2 .slide')[0];
...
/* harmony import */ var foundation_sites_js_foundation_orbit__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! foundation-sites/js/foundation.orbit */ "./node_modules/foundation-sites/js/foundation.orbit.js");
...
foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_interchange__WEBPACK_IMPORTED_MODULE_12__["Interchange"], 'Interchange'); //Foundation.plugin(Magellan, 'Magellan');
//Foundation.plugin(OffCanvas, 'OffCanvas');
//Foundation.plugin(Orbit, 'Orbit');
//Foundation.plugin(ResponsiveMenu, 'ResponsiveMenu');
//Foundation.plugin(ResponsiveToggle, 'ResponsiveToggle');

foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_reveal__WEBPACK_IMPORTED_MODULE_14__["Reveal"], 'Reveal'); //Foundation.plugin(Slider, 'Slider');

foundation_sites_js_foundation_core__WEBPACK_IMPORTED_MODULE_1__["Foundation"].plugin(foundation_sites_js_foundation_smoothScroll__WEBPACK_IMPORTED_MODULE_15__["SmoothScroll"], 'SmoothScroll'); //Foundation.plugin(Sticky, 'Sticky');
...
module.exports = __webpack_require__(/*! /Users/isaac/Development/faraday-park/src/assets/js/app.js */"./src/assets/js/app.js");
